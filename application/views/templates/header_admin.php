            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url();?>index.php/user/promijeni_ulogu"><i class="fa fa-male fa-fw"></i> Promjeni ulogu</a>
                        </li>
						<li>
                            <a href="<?php echo base_url();?>index.php/user/dodaj_sektor"><i class="fa fa-male fa-fw"></i> Dodaj novi sektor</a>
                        </li>
