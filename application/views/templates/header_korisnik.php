            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url();?>index.php/user/podnesi_zahtjev"><i class="fa fa-pencil fa-fw"></i> Podnesi zahtjev</a>
                        </li>
						<li>
                            <a href="<?php echo base_url();?>index.php/user/podnesi_zahtjev_bolovanje"><i class="fa fa-pencil fa-fw"></i> Izvjestaj o bolovanju</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url();?>index.php/user/historija_zahtjeva"><i class="fa fa-list-alt fa-fw"></i> Historija zahtjeva</a>
                        </li>
