<br>
  <div class="page-header">
	...
	<div class="container">
	  <h4>
		<?php echo "Na raspolaganju imate jos ".$this->user_model->provjeri_br_dana();?>
		<?php echo " dana godisnjeg odmora."?>
		 </h4>
...
(function($) {
	...
	var options = {
        ...
        events_source: '<?php echo base_url();?>index.php/calendar/getEvents_korisnik',
		tmpl_cache: false,
		day: 'now',
